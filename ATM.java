...
class OptionMenu extends Account
{
	...
	void getAccountType()
	{
		System.out.println("Select Account Type : Type 1: Current Account ");
	...
	void getCurrent()
	{
		System.out.println(" > Current Account :  Type 1: View Current Balance");
	...
	void getSaving()
	{
		System.out.println(" > Saving Account :   Type 1: View Saving Balance");
		System.out.println("                      Type 2: Withdraw Funds");
		System.out.println("                      Type 3: Deposite Funds");
		System.out.println("                      Type 4: Exit");
		  System.out.print("                      Choice : ");
		...
		case 3:
			...
			break;
		case 4:
			System.out.println("-------------------------------------------------------------------------Thanks for visiting! Visit Again.----------------------------------------------------------------");			getAccountType();
			break;
		default:
			System.out.println("                   Invalid Choice! Enter Valid Choice");
			getSaving();
